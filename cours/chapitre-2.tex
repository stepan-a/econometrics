...
\begin{notes}
  ...
  résultats de cette section, mais avec des conventions différentes. Il faut y prendre
  garde en passant d'un chapitre à l'autre.
  ...
  \begin{center}
    ...
    \begin{tabular}{lll}
      ...
      \midrule
      Variance des erreurs    & $\mathbb V[\varepsilon]=\sigma_{\varepsilon}^2\Omega$
                              & $\mathrm{Var}(\varepsilon)=\Omega$\\
      Estimateur des MCO      & $\hat{\mathbf b}$                 & $\hat\beta$\\
      Estimateur des MCG      & $\tilde{\mathbf b}$               & $\hat\beta_{MCG}$\\
      Estimateur des MCQG     & $\breve{\mathbf b}$               & $\hat\beta_{FGLS}$\\
      Indices                 & $t=1,\dots,T$                     & $i=1,\dots,n$\\
      \bottomrule
    \end{tabular}
  \end{center}
  ...
  \item[\dbend] La différence la plus traître porte sur $\Omega$. Ici la variance des
    erreurs est \underline{factorisée}, $\sigma_{\varepsilon}^2\Omega$, de sorte
    qu'$\Omega$ est sans dimension et vaut $I_T$ dans le cas sphérique. Au chapitre IV
    les variances sont \underline{dans} $\Omega$, qui vaut alors
    $\mathrm{diag}(\sigma_1^2,\dots,\sigma_n^2)$. Les formules ont la même allure, mais
