"""Emplacements de référence, partagés par les scripts du chapitre 3.
...
PGF : figures engendrées, incluses par les transparents. Tout ce qui s'y trouve
      est reconstructible par `make figures`. Les figures du chapitre 3 étant
